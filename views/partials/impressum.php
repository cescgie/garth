<div class="row">
  <div class="body_text">
    <div class="col s12" id="preview_content">
      <?php if(isset($data['impressum'])){
        foreach ($data['impressum'] as $key => $value) {
          echo $value['content'];
        }
      }?>
    </div>
...
<?php if(SESSION::get('admin')) :?>
  ...
  <?php if(isset($data['impressum'])):?>
    <?php foreach ($data['impressum'] as $key => $value) :?>
