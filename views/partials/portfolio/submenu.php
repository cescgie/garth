<nav class="black">
    <ul class="hide-on-med-and-down sub_ul_menu">
      ...
      <li><a <?php if($data['sub_menu_active'] === 'specials'):?>class="active"<?php endif;?> href="<?= DIR ?>portfolio/kategorie/specials">Specials</a></li>
      <li><a <?php if($data['sub_menu_active'] === 'stills'):?>class="active"<?php endif;?> href="<?= DIR ?>portfolio/kategorie/stills">Stills</a></li>
      <li><a <?php if($data['sub_menu_active'] === 'reise'):?>class="active"<?php endif;?> href="<?= DIR ?>portfolio/kategorie/reise">Reise</a></li>
    </ul>
